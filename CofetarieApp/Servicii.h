...
/**
* Subprogram care sorteaza/ordoneaza materiile prime (inregistrarile) din cofetarie (repository) dupa un criteriu dat ca si parametru si crescator sau descrescator in functie de argumentul ordine
* Date de intrare: criteriu - constanta de tipul unsigned char (intreg fara semn pe 1 byte/octet)
*                  ordine   - constanta de tipul unsigned char (intreg fara semn pe 1 byte/octet)
* Preconditii: criteriu si ordine trebuie sa fie ambele intregi din intervalul [0, 1]
*              criteriu = 0 - ordonare dupa nume (lexicografica/alfabetica)
*              criteriu = 1 - ordonare dupa cantitate
*              ordine   = 0 - sortare crscator
*              ordine   = 1 - sortare descrescator
* Date de iesire (rezultate): Materie* - pointer la primul element dintr-o lista de materii prime (inregistrari de tipul Materie)
* Postconditii: Materie* este o copie a listei de materii din repo ordonata/sortata crescator (ordine = 0) sau descrescator (ordine = 1) dupa un criteriu criteriu care poate sa fie 0 (sortare dupa nume) sau 1 (sortare dupa cantitate)
**/
