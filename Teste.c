...
void ruleazaTesteComparareNume()
{
	int result;
	
	// Egalitate (==)
	// reversed = 0 (false)
	result = comparareNume("Ana are mere", "Ana are mere", 0);
	assert(!result);
	...
	// reversed = 1 (true)
	result = comparareNume("Ana are mere", "Ana are mere", 1);
	assert(!result);
	...
	// Mai mic (<)
	// reversed = 0 (false)
	result = comparareNume("abcde", "bbcde", 0);
	assert(result < 0);
	...
	// reversed = 1 (true)
	result = comparareNume("bbcde", "abcde", 1);
	assert(result < 0);
	...
	// Mai mare (>)
	// reversed = 0 (false)
	result = comparareNume("bbcde", "abcde", 0);
	assert(result > 0);
	...
	// reversed = 1 (true)
	result = comparareNume("abcde", "bbcde", 1);
	assert(result > 0);
...
void ruleazaTesteComparareCantitate()
{
	int result;

	// Egalitate (==)
	// reversed = 0 (false)
	result = comparareCantitate(420, 420, 0);
	assert(!result);

	result = comparareCantitate(0, 0, 0);
	assert(!result);

	result = comparareCantitate(69, 69, 0);
	assert(!result);

	// reversed = 1 (true)
	result = comparareCantitate(6, 6, 1);
	assert(!result);

	result = comparareCantitate(4693, 4693, 1);
	assert(!result);

	result = comparareCantitate(891, 891, 1);
	assert(!result);

	// Mai mic (<)
	// reversed = 0 (false)
	result = comparareCantitate(6, 36, 0);
	assert(result < 0);

	result = comparareCantitate(23, 341, 0);
	assert(result < 0);

	result = comparareCantitate(0, 9, 0);
	assert(result < 0);

	result = comparareCantitate(184, 185, 0);
	assert(result < 0);

	// reversed = 1 (true)
	result = comparareCantitate(6, 5, 1);
	assert(result < 0);

	result = comparareCantitate(5477, 75, 1);
	assert(result < 0);

	result = comparareCantitate(143, 92, 1);
	assert(result < 0);

	result = comparareCantitate(124, 8, 1);
	assert(result < 0);

	// Mai mare (>)
	// reversed = 0 (false)
	result = comparareCantitate(6, 5, 0);
	assert(result > 0);

	result = comparareCantitate(5477, 75, 0);
	assert(result > 0);

	result = comparareCantitate(143, 92, 0);
	assert(result > 0);

	result = comparareCantitate(124, 8, 0);
	assert(result > 0);

	// reversed = 1 (true)
	result = comparareCantitate(6, 36, 1);
	assert(result > 0);

	result = comparareCantitate(23, 341, 1);
	assert(result > 0);

	result = comparareCantitate(0, 9, 1);
	assert(result > 0);

	result = comparareCantitate(184, 185, 1);
	assert(result > 0);
}
...
void ruleazaTesteSortareMateriiPrimeCriteriuNumeCrescator()
{
	...
	Materie* lista_sortata = sortareMateriiPrime(0, comparareNumeGen);
...
void ruleazaTesteSortareMateriiPrimeCriteriuNumeDescrescator()
{
	...
	Materie* lista_sortata = sortareMateriiPrime(1, comparareNumeGen);
...
void ruleazaTesteSortareMateriiPrimeCriteriuCantitateCrescator()
{
	...
	Materie* lista_sortata = sortareMateriiPrime(0, comparareCantitateGen);
...
void ruleazaTesteSortareMateriiPrimeCriteriuCantitateDescrescator()
{
	...
	Materie* lista_sortata = sortareMateriiPrime(1, comparareCantitateGen);
...
void ruleazaTesteBusiness()
{
	...
	ruleazaTesteComparareNume();
	ruleazaTesteComparareCantitate();
